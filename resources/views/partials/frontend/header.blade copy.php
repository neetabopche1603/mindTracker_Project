                        ...
                        <div class="container-fluid">
                            ...
                            <div class="site-navigation d-flex flex-row align-items-center">
                                ...
                                <ul class="menu">
                                    ...
                                    <!-- <li class="mega-menu-item {{ request()->is('service*') || request()->is('mood-tracking') || request()->is('meditation') || request()->is('journaling') || request()->is('licensed-therapist-access') || request()->is('community-support') || request()->is('self-care-tools') ? 'active' : '' }}"> -->
                                    ...
                                    <li class="mega-menu-item {{ request()->is('faq') ? 'active' : '' }}">
