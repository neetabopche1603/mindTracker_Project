    ...
    <div class="min-height-200px">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Journal > View Post</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="pd-20 card-box mb-30" style="padding-bottom: 50px">
            ...
            <form method="post" action="#" type="multfor" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$journalPostView->id}}">
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">User :</label>
                    <div class="col-sm-12 col-md-10">
                      <p>{{ $journalPostView->user_name}}</p>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <p>{!! $journalPostView->likesCount !!}</p>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 col-md-8 fallback">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                @php
                                    $files = json_decode($journalPostView->post_files);
                                @endphp
