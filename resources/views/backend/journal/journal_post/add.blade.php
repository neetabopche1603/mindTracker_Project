...
@section('adminTitle', 'Journals Post')
@section('container')
    <div class="min-height-200px">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Journals >Add Post</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="pd-20 card-box mb-30" style="padding-bottom: 50px">
            ...
            <form method="post" action="{{route('admin.journalPostStore')}}" type="multfor" enctype="multipart/form-data">
                @csrf
