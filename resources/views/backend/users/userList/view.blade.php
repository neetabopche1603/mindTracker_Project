            ...
            <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 mb-50">
                <div class="pd-20 card-box height-100-p">
                    <div class="profile-photo">
                        ...
                        <img src="{{$userstViewForm->avatar}}" alt="Avatar" class="avatar-photo img-thumbnail" width="100" height="80">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body pd-5">
                                        <div class="img-container text-center">
                                            ...
                                            <img id="image" src="{{$userstViewForm->avatar}}" alt="Picture" width="350" height="150">
                                        </div>
                                    </div>
